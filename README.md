...
- Deleting a product or removing one of its photos doesn't destroy it right away — it moves to the admin **Recently Deleted** tab, recoverable until it clears automatically every day at 11:59pm in `STORE_TIMEZONE` (or empty it manually).
